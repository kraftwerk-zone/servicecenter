...
Systémová nastavení platí pro celý modul nebo systém (např. interval blikání, typ přijímače, typ brzdového světla). Otevřete je přes ikonu ozubeného kola nebo menu „System“ → „Systemeinstellungen“.
...
| Fahrtenreglertyp | Viz kapitola 9.1 „Fahrtenreglertyp“. |
| Warnblinker beim Rückwärtsfahren | Automatické zapnutí výstražných světel při couvání. |
| Bremslicht Sensitivität | Citlivost inteligentního brzdového světla. |
| Bremslicht Nachleuchten | Doba dohoření brzdového světla. |
| Lenkungstyp | Viz kapitola 9.3 „Lenkungstyp“. |
| Blinker Schwellwert | Prahová hodnota pro automatické zapnutí blinkru. |
| Kurvenlichttyp | Viz kapitola 0 „Kurvenlichttyp“. |
...
Standardní ovládání probíhá přes čtyři proporcionální kanály (plyn vlevo, řízení vpravo). Kanál K2 přepíná mezi skupinami funkcí Světlo, Jízda a Doplňky.
...
image45.png
 ...
 až ![](images/image\_014.png)

image54.png

## Základní nebo doplňkové funkce panelu
...
Každý kanál (kromě plynu a řízení) lze individuálně přiřadit. K1 a K2 podporují plné i poloviční výchylky, K3 až K12 pouze plné výchylky.
